...
public class Main {
  public static void main(String[] args) throws IOException {
    ...
    System.out.println("\nWould you like to try an item? (yes/no)");
    String s = diskin.readLine();
    while (!s.equalsIgnoreCase("yes") && (!s.equalsIgnoreCase("no"))) { // if non-"yes/no" answer
      System.out.println("\nSorry, I don't understand...Try again? (yes/no) ");
      s = diskin.readLine();
    }
    while (s.equalsIgnoreCase("yes")) {
      System.out.println("\nWhich item number would you like? ");
      ...
      try {
        ...
        System.out.println("\nWould you like another item? (yes/no)");
        s = diskin.readLine();
        while (!s.equalsIgnoreCase("yes") && (!s.equalsIgnoreCase("no"))) {
          System.out.println("\nSorry, I don't understand...Try again? (yes/no) ");
          s = diskin.readLine();
        }
      } catch (NumberFormatException nfe) { // catches non-integer answer
        System.out.println("\nSorry, I don't understand...Try again? (yes/no) ");
        s = diskin.readLine();
      }
      while (!s.equalsIgnoreCase("yes") && (!s.equalsIgnoreCase("no"))) {
